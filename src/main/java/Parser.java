...
class Parser{
     ...
     */
    static void insert_event(Ui ui, SimpleDateFormat f_date, ArrayList<Task> task_list, String input) {
        String[] token;
        ui.line();
        try{
     ...
     * @param input command as well as the message from the user
     */
    static void insert_deadline(Ui ui, SimpleDateFormat f_date, ArrayList<Task> task_list, String input) {
        String[] token;
        ui.line();
        try {
            input = input.replaceAll("\\s+", " ");
     ...
     * @param input command as well as the message from the user
     */
    static void insert_todo(Ui ui, ArrayList<Task> task_list, String input) {
        ui.line();
        try{
            input = input.replaceAll("\\s+", " ");
     ...
     * @param input command as well as the message from the user
     */
    static void findsTaskInList(Ui ui, ArrayList<Task> task_list, String input) {
        ui.line();
     ...
     * @param input command as well as the message from the user
     */
    static void delete_task(Ui ui, ArrayList<Task> task_list, String input) {
        String[] token;
        ui.line();
        try {
            token = input.split(" ");
     ...
     * @param input command as well as the message from the user
     */
    static void tick_list(Ui ui, ArrayList<Task> task_list, String input) {
        String[] token;
        ui.line();
        try{
            token = input.split(" ");
     ...
     * @param task_list ArrayList to store all the tasks
     */
    static void show_list(Ui ui, ArrayList<Task> task_list) {
        ui.line();
        if(task_list.size() == 0) {
     ...
     * @param task_list ArrayList to store all the tasks
     */
    static void exit(Ui ui, Storage file, ArrayList<Task> task_list) {
